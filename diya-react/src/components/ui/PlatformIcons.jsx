...
// Instagram Icon (Filled Gradient Style)
...
// Facebook Icon (Filled Round Logo)
...
export const PLATFORMS_DATA = [
    ...
    },
    {
        id: 'x',
        name: 'X (Twitter)',
        color: '#FFFFFF', // White for visibility on dark mode
        icon: XIcon
    },
    {
        id: 'facebook',
